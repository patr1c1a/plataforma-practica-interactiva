...
class TestsFuncionesListas(unittest.TestCase):
    ...
    def test_productoria_numeros(self):
        pruebas = {
            ...
            "Argumento usado: numeros=[]": [productoria_numeros([]), None],
            "Argumento usado: numeros=[1, 1, 1]": [productoria_numeros([1, 1, 1]), 1],
        }
    ...
    def test_mayor_ganancia(self):
        pruebas = {
            ...
            "Argumento usado: precios=[12, 21]": [mayor_ganancia([12, 21]), 9],
            "Argumento usado: precios=[21, 12]": [mayor_ganancia([21, 12]), 9],
        }
        for prueba, (a, b) in pruebas.items():
            with self.subTest(prueba=prueba):
                self.assertEqual(a, b, prueba)
    ...
    def test_elementos_unicos(self):
        pruebas = {
            ...
            "Argumento usado: []": [elementos_unicos([]), []],
        }
        for prueba, (a, b) in pruebas.items():
            with self.subTest(prueba=prueba):
                self.assertEqual(a, b, prueba)
    ...
    def test_sumar_indice(self):
        pruebas = {
            ...
            "Argumento usado: numeros=[-6, 4, -2.8, 0]": [
                sumar_indice([-6, 4, -2.8, 0]),
                [-6, 5, 0.8, 3],
            ],
            "Argumento usado: numeros=[0, 0, 0]": [sumar_indice([0, 0, 0]), [0, 1, 2]],
            "Argumento usado: numeros=[]": [sumar_indice([]), []],
        }
        for prueba, (a, b) in pruebas.items():
            with self.subTest(prueba=prueba):
                self.assertEqual(a, b, prueba)
    ...
    def test_sumas_parciales(self):
        pruebas = {
            ...
            "Argumento usado: numeros=[]": [sumas_parciales([]), []],
    ...
    def test_numeros_faltantes(self):
        pruebas = {
            ...
            "Argumento usado: numeros=[5]": [numeros_faltantes([5]), [0]],
            "Argumento usado: numeros=[]": [numeros_faltantes([]), []],
        }
        for prueba, (a, b) in pruebas.items():
            with self.subTest(prueba=prueba):
                self.assertEqual(a, b, prueba)
    ...
    def test_cuantos_numeros_menores(self):
        pruebas = {
            ...
            "Argumento usado: numeros=[]": [cuantos_numeros_menores([]), []],
            "Argumento usado: numeros=[1]": [cuantos_numeros_menores([1]), [0]],
        }
        for prueba, (a, b) in pruebas.items():
            with self.subTest(prueba=prueba):
                self.assertEqual(a, b, prueba)
    ...
    def test_dos_maximos(self):
        pruebas = {
            ...
            "Argumento usado: numeros=[1, 2]": [dos_maximos([1, 2]), (2, 1)],
        }
        for prueba, (a, b) in pruebas.items():
            with self.subTest(prueba=prueba):
                self.assertEqual(a, b, prueba)
    ...
    def test_desplazar_ceros(self):
        pruebas = {
            ...
            "Argumento usado: numeros=[]": [desplazar_ceros([]), []],
        }
        for prueba, (a, b) in pruebas.items():
            with self.subTest(prueba=prueba):
                self.assertEqual(a, b, prueba)
    ...
    def test_desanidar(self):
        pruebas = {
            ...
            "Argumento usado: listas=[[], [], []]": [desanidar([[], [], []]), []],
        }
        for prueba, (a, b) in pruebas.items():
            with self.subTest(prueba=prueba):
                self.assertEqual(a, b, prueba)
    ...
    def test_cantidad_aprobados(self):
        pruebas = {
            ...
            "Argumento usado: resultados_examen=[]": [cantidad_aprobados([]), 0],
        }
        for prueba, (a, b) in pruebas.items():
            with self.subTest(prueba=prueba):
                self.assertEqual(a, b, prueba)
    ...
    def test_suma_diagonal(self):
        pruebas = {
            ...
            "Argumento usado: matriz=[]": [suma_diagonal([]), 0],
            "Argumento usado: matriz=[[4]]": [suma_diagonal([[4]]), 4],
        }
        for prueba, (a, b) in pruebas.items():
            with self.subTest(prueba=prueba):
                self.assertEqual(a, b, prueba)
